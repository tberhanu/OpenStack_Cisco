...
cp $tools_dir/supporting_files/{audit_tc_list.py,landscape_of_execution.py,requirements.txt,data_cae.xml,data_cae_vm.xml,data_p3.xml,prod_env_variables.py,nonprod_env_variables.py} .
