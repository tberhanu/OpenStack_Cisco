...
Description : This file is meant to maintain a dictionary of nonprod env.
              related variables along with their values as key-value pairs.
